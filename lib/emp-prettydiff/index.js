    ...
    var prettydiff = function prettydiff_(api) {
        ...
        var startTime = Date.now(),
            core      = function core_(api) {
                ...
                // console.log("prettyfy: options.mode:", options.mode);
                if (options.mode === "diff") {
                    ...
                    // console.log("prettyfy: core --- mode else,options.lang:", options.lang );
