...
(function markuppretty_init() {
    ...
    var markuppretty = function markuppretty_(options) {
        // console.log("markuppretty: initial ---------");
        ...
        (function markuppretty__tokenize() {
            var a = 0,
                ...
                tag = function markuppretty__tokenize_tag(end) {
                    ...
                    for (a = a; a < c; a = a + 1) {
                        if (b[a] === "\n") {
                            if (lexer[0] === "#" && options.apacheVelocity === true) {
                                a = a - 1;
                                break;
                            }
                            line = line + 1;
                        }
                        if (preserve === true || slt === true  || (/\s/).test(b[a]) === false) {
                            lexer.push(b[a]);
                                ...
                                if (stest === true && (/\s/).test(b[a]) === false && b[a] !== lastchar) {
                                    ...
                                    for (a = a; a < c; a = a + 1) {
                                        ...
                                        if (sltattr) {
                                          ...
                                          sltattr = true;
                                        } else if ((b[a] === "<" || b[a] === ">") && (quote === "" || quote === ">") && options.jsx === false) {
                                            if (quote === "" && b[a] === "<") {
                                                quote = ">";
                                                braccount = 1;
                                            } else if (quote === ">") {
                ...
                content = function markuppretty__tokenize_content() {
                    ...
                    for (a = a; a < c; a = a + 1) {
                        ...
                        if (ext === false && lexer.length > 0 && ((b[a] === "}" && b[a + 1] === "#" ) || (b[a] === "<" && b[a + 1] !== "=" && (/\s|\d/).test(b[a + 1]) === false) || (b[a] === "[" && b[a + 1] === "%") || (b[a] === "{" && (options.jsx === true || options.dustjs === true || b[a + 1] === "{" || b[a + 1] === "%" || b[a + 1] === "@" || b[a + 1] === "#")))) {
